...
/**
 * LinkSearch represents the model behind the search form about `backend\models\Channelthird`.
 */
class LinkSearch extends Channelthird
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params,$power)
    {
        ...
        $command = $connection->createCommand('SELECT * FROM auth_assignment WHERE item_name="h5渠道"');
